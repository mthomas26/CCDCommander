VERSION 5.00
Begin VB.Form frmSkipAtAlt 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Skip At Altitude Action"
   ClientHeight    =   6015
   ClientLeft      =   2760
   ClientTop       =   3750
   ClientWidth     =   4050
   HelpContextID   =   2200
   Icon            =   "frmSkipAtAlt.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6015
   ...
   Begin VB.Label lblMeridian 
      AutoSize        =   -1  'True
      Caption         =   "If the object crosses the meridian, the skip will execute, regardless of the altitude set above."
      Height          =   390
      Left            =   180
      TabIndex        =   25
      Top             =   5100
   ...
   Begin VB.Label Label9 
      ...
      AutoSize        =   -1  'True
      Caption         =   "Skip when object is at altitude:"
      Height          =   195
      Left            =   60
      TabIndex        =   14
      Top             =   3960
   ...
   End
End
Attribute VB_Name = "frmSkipAtAlt"
...
Private Const RegistryName = "SkipAheadAtAlt"
...
Public Sub PutFormDataIntoClass(clsAction As SkipAheadAtAltAction)
...
Public Sub GetFormDataFromClass(clsAction As SkipAheadAtAltAction)
    Dim RA As Double
    Dim Dec As Double
